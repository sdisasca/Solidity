...
contract Auction {
 // chiense auction smartcontract - coursera Smart contract course Buffalo & NYC
    // Data
   ...
   //Structure to hold the details of a persons
    ...
    function Auction() public payable{    //constructor
        ...
        beneficiary= msg.sender;
          //** End code here. SOUNDS OK **/
        uint[] memory emptyArray;
        items[0] = Item({itemId:0,itemTokens:emptyArray});
 
        //Part 1 Task 2. Initialize two items with at index 1 and 2. SOUNDS OK
