...
//other code
  ///return ballotInstance.register(accounts[6], { from: accounts[1]})
    ...
    return /*<CODE HERE>*/auctionInstance.bid(itemId=0,count=6,{from:accounts[1]}).then(function (istance) {
      /*
  ...
  it("Should set winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
        return /*<CODE HERE>*/auctionInstance.bid(idetmid=1,count=5,{ from: accounts[3]})
    }).then(function() {
      /**********
      TASK 12: Call bid method from accounts[4] of Auction.sol using auctionInstance and
      pass itemId=2, count=5 as arguments
      ***********/
        return /*<CODE HERE>*/auctionInstance.bid(idetmid=2,count=5,{ from: accounts[4]})
    }).then(function() {
      /**********
      ...
      ***********/
        return /*<CODE HERE>*/auctionInstance.winners(itemId=0,{ from: accounts[0]})
    }).then(function(result) {
      /**********
      ...
      ***********/
      /*<CODE HERE>*/assert.notEqual('0x01',result.receipt.status,'message');


      /**********
      TASK 16: call winners function from accounts[0] to get the winner of item id 1
      ***********/
      return /*<CODE HERE>*/auctionInstance.Winners(itemId=1,{ from: accounts[0]})
    }).then(function(result) {
      /**********
      ...
      ***********/
      return /*<CODE HERE>*/auctionInstance.Winners(itemId=2,{ from: accounts[3]});
    }).then(function(result) {
      /**********
